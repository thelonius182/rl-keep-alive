...
#     parms DEV = -File "C:\cz_salsa\r_proj_develop\report_rls_alive.ps1"
#     parms PRD = -File "g:\R_released_projects\report_rls_alive.ps1"
#     beginnen in = <leeg>
# -------------------------------------------------------------------------------------------
...
$logFilePath = Join-Path -Path "c:\Users\nipper\Logs\dev" -ChildPath "report_rls_alive_task_${dateString}.log"
...
$script_home = "C:\cz_salsa\r_proj_develop\rl-keep-alive"
